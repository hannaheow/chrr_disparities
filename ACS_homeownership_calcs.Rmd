...
tract_ci_all_years = lapply(names(acs_datasets), function(year) { 
...
tract_ci_all_years = bind_rows(tract_ci_all_years)
...
# save raw value outputs 
```{r}
save(income_ci_all_years, file = "calcd_data_how/income_level.RData")
save(race_ci_all_years, file = "calcd_data_how/race_level.RData") 
save(tract_ci_all_years, file = "calcd_data_how/tract_level.RData")
